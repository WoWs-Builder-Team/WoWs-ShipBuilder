...
public partial class ShipBuildViewModel : ReactiveObject
{
    ...
    public ShipBuildContainer CreateShipBuildContainer(ShipBuildContainer baseContainer)
    {
        ...
        ImmutableArray<int> activatedConsumables = this.ConsumableViewModel.ActivatedSlots.Any() ? this.ConsumableViewModel.ActivatedSlots.ToImmutableArray() : ImmutableArray<int>.Empty;
    ...
    {
        return ShipDataContainer.CreateFromShip(this.CurrentShip, this.ShipModuleViewModel.SelectedModules.ToList(), modifiers.ToList());
    }
