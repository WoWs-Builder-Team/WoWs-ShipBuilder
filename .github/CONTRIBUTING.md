...
To test the release-compatibility of your local changes, run the local release test script `build/BuildVelopackRelease.ps1` and install the created executable locally.
