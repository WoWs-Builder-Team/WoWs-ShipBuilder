...
using static WoWsShipBuilder.Desktop.CustomControls.DispersionPlot;
using Legend = OxyPlot.Legends.Legend;
using LinearAxis = OxyPlot.Axes.LinearAxis;
using LineSeries = OxyPlot.Series.LineSeries;
using ValueSelectionViewModel = WoWsShipBuilder.Desktop.ViewModels.Helper.ValueSelectionViewModel;

namespace WoWsShipBuilder.Desktop.ViewModels.DispersionPlot
{
